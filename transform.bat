...
set XML_FILE=sample.yaml.xml
set XSLT_FILE=xml-to-yaml.xslt
...
powershell -ExecutionPolicy Bypass -File "transform.ps1" -XmlFile "%XML_FILE%" -XsltFile "%XSLT_FILE%" -OutputFile "%OUTPUT_FILE%"
